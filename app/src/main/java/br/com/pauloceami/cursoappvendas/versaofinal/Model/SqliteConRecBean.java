...
public class SqliteConRecBean {
    ...
    private double rec_valor_receber;
    ...
    public SqliteConRecBean(double rec_valorpago, String rec_data_que_pagou, String rec_recebeu_com, String rec_enviado, String vendac_chave, Integer rec_numparcela) {
    ...
    public SqliteConRecBean(Integer rec_numparcela, Integer rec_cli_codigo, String rec_cli_nome, String vendac_chave, String rec_datamovimento, double rec_valor_receber, double rec_valorpago, String rec_datavencimento, String rec_data_que_pagou, String rec_recebeu_com, String rec_enviado) {
        this.rec_numparcela = rec_numparcela;
    ...
    public double getRec_valor_receber() {
        return rec_valor_receber;
    }

    public void setRec_valor_receber(double rec_valor_receber) {
        this.rec_valor_receber = Util.formatDouble(rec_valor_receber);
    }
    ...
    public void setRec_valorpago(double rec_valorpago) {
        this.rec_valorpago = Util.formatDouble(rec_valorpago);
    }
